...
function qs_auto_ai_timeline_events( $run_id ) {
	...
	if ( is_array( $events ) && $events ) {
		usort(
			$events,
			static function ( $a, $b ) {
				return absint( isset( $a['sequence'] ) ? $a['sequence'] : 0 ) <=> absint( isset( $b['sequence'] ) ? $b['sequence'] : 0 );
			}
		);
...
function qs_auto_ai_state( $run_id ) {
	...
	$duration     = $start_ts && $end_ts ? max( 0, $end_ts - $start_ts ) : 0;
...
function qs_auto_ai_testing_page() {
	...
	<div class="qs-auto-ai">
		...
		<section class="qs-auto-ai-run" <?php echo $state ? '' : 'hidden'; ?>>
			...
			<section class="qs-auto-ai-view-panel" data-auto-ai-panel="timeline" role="tabpanel">
				<div class="qs-auto-ai-summary" id="qs-auto-ai-summary"></div>
				<div class="qs-auto-ai-timeline-head">
					<div class="qs-auto-ai-lane-head joiner"><strong>JOINER</strong><span id="qs-auto-ai-timeline-joiner"></span></div>
					<div class="qs-auto-ai-lane-center">WORKFLOW</div>
					<div class="qs-auto-ai-lane-head admin"><strong>LF ADMIN</strong><span id="qs-auto-ai-timeline-admin"></span></div>
				</div>
	...
	.qs-auto-ai-view-tabs{display:flex;gap:4px;padding:12px 18px 0;background:#f6f7f7;border-bottom:1px solid #dcdcde}
	.qs-auto-ai-view-tab{appearance:none;border:1px solid #c3c4c7;border-bottom:0;background:#f0f0f1;color:#2c3338;padding:9px 15px;border-radius:4px 4px 0 0;cursor:pointer;font-weight:600}
	.qs-auto-ai-view-tab:hover{background:#fff}
	.qs-auto-ai-view-tab.is-active{position:relative;top:1px;background:#fff;color:#135e96;border-color:#8c8f94}
	.qs-auto-ai-view-panel[hidden]{display:none!important}
	.qs-auto-ai-summary{display:flex;align-items:center;flex-wrap:wrap;margin:18px 22px 12px;padding:11px 14px;border:1px solid #b8dfc4;background:#f0f9f3;border-radius:5px;color:#1d2327}
	.qs-auto-ai-summary-item{display:inline-flex;align-items:center;gap:6px;padding:0 14px;border-right:1px solid #c8d8cd}
	.qs-auto-ai-summary-item:first-child{padding-left:0}
	.qs-auto-ai-summary-item:last-of-type{border-right:0}
	.qs-auto-ai-summary-check{display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;border-radius:50%;background:#16803c;color:#fff;font-size:13px;font-weight:700}
	.qs-auto-ai-summary-status{margin-left:auto;padding:4px 9px;border-radius:4px;background:#def3e6;color:#1f6f3d;font-size:11px;font-weight:700;letter-spacing:.03em}
	.qs-auto-ai-summary-status.failed{background:#fce8e6;color:#a12622}.qs-auto-ai-summary-status.running{background:#e6eef9;color:#275a8e}.qs-auto-ai-summary-status.paused,.qs-auto-ai-summary-status.stopped{background:#fff1d6;color:#8a5a00}
	.qs-auto-ai-timeline-head{display:grid;grid-template-columns:minmax(0,1fr) 86px minmax(0,1fr);gap:18px;padding:0 22px 10px}
	.qs-auto-ai-lane-head{padding:12px 16px;border-radius:5px;color:#fff}.qs-auto-ai-lane-head strong,.qs-auto-ai-lane-head span{display:block}.qs-auto-ai-lane-head span{margin-top:3px;font-size:12px;opacity:.9}
	.qs-auto-ai-lane-head.joiner{background:#43586a}.qs-auto-ai-lane-head.admin{background:#4e1625}
	.qs-auto-ai-lane-center{display:flex;align-items:center;justify-content:center;color:#646970;font-size:10px;font-weight:700;letter-spacing:.08em}
	.qs-auto-ai-timeline{position:relative;padding:4px 22px 28px}.qs-auto-ai-timeline:before{content:"";position:absolute;top:0;bottom:26px;left:50%;width:2px;transform:translateX(-1px);background:#b8bec5}
	.qs-auto-ai-timeline-row{position:relative;display:grid;grid-template-columns:minmax(0,1fr) 86px minmax(0,1fr);gap:18px;align-items:start;min-height:76px}
	.qs-auto-ai-timeline-node-wrap{position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;padding-top:3px}
	.qs-auto-ai-timeline-node{display:flex;align-items:center;justify-content:center;width:34px;height:34px;border:3px solid #16803c;border-radius:50%;background:#fff;color:#16803c;font-weight:700;box-sizing:border-box}
	.qs-auto-ai-timeline-row.warning .qs-auto-ai-timeline-node{border-color:#dba617;color:#8a5a00}.qs-auto-ai-timeline-row.error .qs-auto-ai-timeline-node{border-color:#d63638;color:#d63638}.qs-auto-ai-timeline-row.info .qs-auto-ai-timeline-node{border-color:#2271b1;color:#2271b1}
	.qs-auto-ai-timeline-time{margin-top:4px;padding:1px 4px;background:#fff;color:#646970;font-size:10px}
	.qs-auto-ai-timeline-card{position:relative;margin-bottom:12px;padding:11px 13px;border:1px solid #dcdcde;border-radius:5px;background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.03)}
	.qs-auto-ai-timeline-card:before{content:"✓";display:inline-flex;float:left;align-items:center;justify-content:center;width:17px;height:17px;margin:1px 9px 0 0;border-radius:50%;background:#16803c;color:#fff;font-size:11px;font-weight:700}
	.qs-auto-ai-timeline-row.warning .qs-auto-ai-timeline-card:before{content:"!";background:#dba617}.qs-auto-ai-timeline-row.error .qs-auto-ai-timeline-card:before{content:"×";background:#d63638}.qs-auto-ai-timeline-row.info .qs-auto-ai-timeline-card:before{content:"•";background:#2271b1}
	.qs-auto-ai-timeline-card:after{content:"";position:absolute;top:20px;width:44px;height:1px;background:#89939e}
	.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-card{grid-column:1}.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-node-wrap{grid-column:2}.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-card:after{right:-45px}
	.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-node-wrap{grid-column:2}.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-card{grid-column:3}.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-card:after{left:-45px}
	.qs-auto-ai-timeline-message{overflow:hidden;color:#1d2327;line-height:1.42}.qs-auto-ai-timeline-message strong{display:block;margin-bottom:2px}.qs-auto-ai-timeline-detail{color:#50575e}.qs-auto-ai-timeline-link{display:inline-block;margin-top:5px}
	.qs-auto-ai-timeline-row.is-latest .qs-auto-ai-timeline-card{animation:qs-auto-ai-timeline-latest 4.5s ease-out}
	@keyframes qs-auto-ai-timeline-latest{0%,18%{background:#c9f0d5;box-shadow:0 0 0 1px rgba(22,128,60,.18),0 2px 8px rgba(22,128,60,.12)}100%{background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.03)}}
	.qs-auto-ai-columns{display:grid;grid-template-columns:1fr 1fr;min-height:430px}
	.qs-auto-ai-log-panel:first-child{border-right:1px solid #dcdcde}.qs-auto-ai-log-panel header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:13px 16px;background:#f6f7f7;border-bottom:1px solid #dcdcde}.qs-auto-ai-log-panel header strong{font-size:12px;letter-spacing:.05em}
	.qs-auto-ai-log{padding:14px;max-height:520px;overflow:auto}.qs-auto-ai-log-entry{--qs-auto-ai-log-bg:#f6f7f7;position:relative;padding:9px 10px 9px 32px;margin-bottom:8px;border-left:3px solid #c3c4c7;background:var(--qs-auto-ai-log-bg)}.qs-auto-ai-log-entry.is-latest{animation:qs-auto-ai-latest-log 4.5s ease-out}
	@keyframes qs-auto-ai-latest-log{0%,18%{background:#c9f0d5;box-shadow:0 0 0 1px rgba(22,128,60,.18),0 2px 8px rgba(22,128,60,.12)}100%{background:var(--qs-auto-ai-log-bg);box-shadow:none}}
	.qs-auto-ai-log-entry:before{content:"•";position:absolute;left:12px;top:8px;font-weight:700}.qs-auto-ai-log-entry.success{border-left-color:#16803c}.qs-auto-ai-log-entry.success:before{content:"✓";color:#16803c}.qs-auto-ai-log-entry.warning{border-left-color:#dba617}.qs-auto-ai-log-entry.warning:before{content:"!";color:#8a5a00}.qs-auto-ai-log-entry.error{--qs-auto-ai-log-bg:#fcf0f1;border-left-color:#d63638}.qs-auto-ai-log-entry.error:before{content:"×";color:#d63638}
	.qs-auto-ai-log-entry time{display:block;color:#8c8f94;font-size:11px;margin-bottom:2px}.qs-auto-ai-log-entry a{margin-left:8px}
	.qs-auto-ai-emails{padding:18px 22px}.qs-auto-ai-email-row{display:grid;grid-template-columns:145px 1fr 2fr auto;gap:12px;padding:9px 0;border-top:1px solid #f0f0f1;align-items:center}
	.qs-auto-ai-history{margin:26px 0}
	@media(max-width:900px){.qs-auto-ai-setup,.qs-auto-ai-columns{grid-template-columns:1fr}.qs-auto-ai-log-panel:first-child{border-right:0;border-bottom:1px solid #dcdcde}.qs-auto-ai-run-header,.qs-auto-ai-start{align-items:flex-start;flex-direction:column}.qs-auto-ai-status-wrap{min-width:0;width:100%;text-align:left}.qs-auto-ai-email-row{grid-template-columns:1fr}.qs-auto-ai-title{flex-direction:column}.qs-auto-ai-summary{align-items:flex-start}.qs-auto-ai-summary-item{padding:3px 8px;border-right:0}.qs-auto-ai-summary-status{margin-left:0}.qs-auto-ai-timeline-head{grid-template-columns:1fr 62px 1fr;gap:8px;padding-left:10px;padding-right:10px}.qs-auto-ai-timeline{padding-left:10px;padding-right:10px}.qs-auto-ai-timeline-row{grid-template-columns:minmax(0,1fr) 62px minmax(0,1fr);gap:8px}.qs-auto-ai-timeline-card:after{width:26px}.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-card:after{right:-27px}.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-card:after{left:-27px}}
	@media(max-width:650px){.qs-auto-ai-timeline-head{display:none}.qs-auto-ai-timeline:before{left:36px}.qs-auto-ai-timeline-row{display:grid;grid-template-columns:52px minmax(0,1fr);gap:8px;min-height:0;margin-bottom:12px}.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-node-wrap,.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-node-wrap{grid-column:1;grid-row:1}.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-card,.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-card{grid-column:2;grid-row:1}.qs-auto-ai-timeline-row.joiner .qs-auto-ai-timeline-card:after,.qs-auto-ai-timeline-row.admin .qs-auto-ai-timeline-card:after{left:-17px;right:auto;width:16px}}
	</style>
	...
	(function(){
		...
		let renderedTimelineCount=state&&Array.isArray(state.timeline_events)?state.timeline_events.length:0;
		...
		function setView(view){
			activeView=view;
			document.querySelectorAll('[data-auto-ai-view]').forEach(button=>{
				const selected=button.dataset.autoAiView===view;
				button.classList.toggle('is-active',selected);
				button.setAttribute('aria-selected',selected?'true':'false');
			});
			document.querySelectorAll('[data-auto-ai-panel]').forEach(panel=>{panel.hidden=panel.dataset.autoAiPanel!==view;});
		}
		function timelineTitle(message){
			const rules=[
				[/Using existing real Joiner|Permanent Joiner user created/i,'Joiner selected'],[/Real emails are ENABLED/i,'Real email delivery enabled'],[/Real quote .* created/i,'Quote created'],[/Selections saved/i,'Builder selections saved'],[/submitted for LF review/i,'Quote submitted'],[/New Quote notification/i,'New Quote notification sent'],[/Quote received from/i,'Quote received'],[/Quotation PDF rendered/i,'Quotation PDF generated'],[/deposit order .* created/i,'Deposit order created'],[/Deposit email .* delivery/i,'Deposit payment email sent'],[/order .* placed on Direct bank transfer/i,'Direct bank transfer selected'],[/Deposit bank payment confirmed/i,'Deposit payment confirmed'],[/Deposit Paid confirmed/i,'Deposit workflow completed'],[/marked In Production/i,'Quote In Production'],[/Additional Charge/i,'Additional charge applied'],[/final-balance .* created/i,'Final balance order created'],[/Final-payment email .* delivery/i,'Final payment email sent'],[/Balance bank payment confirmed/i,'Final payment confirmed'],[/Final WooCommerce order .* Completed/i,'Final order completed'],[/Quote now shows Completed/i,'Quote completed'],[/AUTO AI TEST PASSED/i,'Auto AI Test passed'],[/paused/i,'Test paused'],[/resumed/i,'Test resumed'],[/Retrying/i,'Retrying failed step'],[/stopped/i,'Test stopped']
			];
			for(const [pattern,title] of rules){if(pattern.test(message))return title;}
			return message.length>64?message.slice(0,61)+'…':message;
		}
		function renderTimeline(s){
			const events=s.timeline_events||[];
			const target=document.getElementById('qs-auto-ai-timeline');
			const hasNew=events.length>renderedTimelineCount;
			target.innerHTML=events.map((event,index)=>{
				const side=event.side==='admin'?'admin':'joiner';
				const type=['success','warning','error','info'].includes(event.type)?event.type:'info';
				const latest=hasNew&&index===events.length-1?' is-latest':'';
				const title=timelineTitle(event.message||'');
				const detail=title===(event.message||'')?'':event.message;
				const card='<div class="qs-auto-ai-timeline-card"><div class="qs-auto-ai-timeline-message"><strong>'+esc(title)+'</strong>'+(detail?'<div class="qs-auto-ai-timeline-detail">'+esc(detail)+'</div>':'')+(event.url?'<a class="qs-auto-ai-timeline-link" href="'+esc(event.url)+'" target="_blank" rel="noopener">'+esc(event.link_label||'View')+'</a>':'')+'</div></div>';
				const node='<div class="qs-auto-ai-timeline-node-wrap"><span class="qs-auto-ai-timeline-node">'+esc(event.sequence||index+1)+'</span><time class="qs-auto-ai-timeline-time">'+esc(event.time||'')+'</time></div>';
				return '<div class="qs-auto-ai-timeline-row '+side+' '+type+latest+'">'+(side==='joiner'?card:'')+node+(side==='admin'?card:'')+'</div>';
			}).join('')||'<p class="description">Timeline events will appear here as the test runs.</p>';
			renderedTimelineCount=events.length;

			const passed=s.status==='passed';
			const summaryIcon=passed?'✓':(s.status==='failed'?'×':'•');
			const statusText=passed?'AUTO AI TEST PASSED':String(s.status_label||s.status||'').toUpperCase();
			const seconds=Number(s.duration_seconds||0);
			const duration=seconds<60?(seconds+' sec'):(Math.floor(seconds/60)+'m '+(seconds%60)+'s');
			document.getElementById('qs-auto-ai-summary').innerHTML=
				'<span class="qs-auto-ai-summary-item"><span class="qs-auto-ai-summary-check">'+esc(summaryIcon)+'</span><strong>'+esc(s.current_step)+' / '+esc(s.total_steps)+'</strong> workflow steps</span>'+
				'<span class="qs-auto-ai-summary-item"><strong>'+esc(s.order_count||0)+'</strong> Woo orders</span>'+
				'<span class="qs-auto-ai-summary-item"><strong>'+esc(s.email_count||0)+'</strong> captured emails</span>'+
				'<span class="qs-auto-ai-summary-item">Total: <strong>'+esc(s.quote_total||'—')+'</strong></span>'+
				'<span class="qs-auto-ai-summary-item"><strong>'+esc(duration)+'</strong></span>'+
				'<span class="qs-auto-ai-summary-status '+esc(s.status)+'">'+esc(statusText)+'</span>';
			document.getElementById('qs-auto-ai-timeline-joiner').textContent=s.joiner_name+(s.joiner_email?' · '+s.joiner_email:'');
			document.getElementById('qs-auto-ai-timeline-admin').textContent=s.admin_name||'';
			document.getElementById('qs-auto-ai-email-count').textContent='('+(s.email_count||0)+')';
		}
		function render(s){
			if(!s)return;
			state=s;runSection.hidden=false;
			if(!viewInitialized){activeView=s.status==='running'?'logs':'timeline';viewInitialized=true;setView(activeView);}
		...
		document.querySelectorAll('[data-auto-ai-view]').forEach(button=>button.addEventListener('click',function(){viewInitialized=true;setView(this.dataset.autoAiView);}));
		...
		document.getElementById('qs-auto-ai-start')?.addEventListener('click',async function(){
			...
			try{
				...
				activeView='logs';viewInitialized=true;setView('logs');renderedTimelineCount=0;
				render(data);
