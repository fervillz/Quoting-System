...
require_once QS_PATH . 'customer-details.php';
require_once QS_PATH . 'setup/defaults.php';
require_once QS_PATH . 'setup/setup.php';
require_once QS_PATH . 'setup/config-transfer.php';
require_once QS_PATH . 'portal-mode.php';
...
require_once QS_PATH . 'workflow-editing.php';
...
require_once QS_PATH . 'admin/delivery-fee.php';
require_once QS_PATH . 'admin/joiners.php';
require_once QS_PATH . 'admin/settings.php';
require_once QS_PATH . 'admin/test-joiner.php';
require_once QS_PATH . 'admin/auto-ai-testing.php';
...
register_activation_hook(
	...
	function () {
		...
		add_option( 'qs_portal_mode', function_exists( 'qs_is_live_loughlin_site' ) && qs_is_live_loughlin_site() ? 'setup' : 'test' );
		flush_rewrite_rules();
	}
);
